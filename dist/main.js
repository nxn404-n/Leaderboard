...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Person)\n/* harmony export */ });\nclass Person {\n  constructor(user, score) {\n    this.user = user;\n    this.score = score;\n  }\n}\n\n//# sourceURL=webpack://Leaderboard/./modules/Class.js?");

/***/ }),

/***/ "./modules/DOMselector.js":
/*!********************************!*\
  !*** ./modules/DOMselector.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"formEl\": () => (/* binding */ formEl),\n/* harmony export */   \"listEl\": () => (/* binding */ listEl),\n/* harmony export */   \"nameInput\": () => (/* binding */ nameInput),\n/* harmony export */   \"refreshBtn\": () => (/* binding */ refreshBtn),\n/* harmony export */   \"scoreInput\": () => (/* binding */ scoreInput)\n/* harmony export */ });\nconst listEl = document.querySelector('.main__box1__ul');\nconst refreshBtn = document.querySelector('.main__box1__header__refreshbtn');\nconst formEl = document.querySelector('form');\nconst nameInput = document.querySelector('.name');\nconst scoreInput = document.querySelector('.score');\n\n//# sourceURL=webpack://Leaderboard/./modules/DOMselector.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _DOMselector_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DOMselector.js */ \"./modules/DOMselector.js\");\n\n\nconst showList = async (url) => {\n  const response = await fetch(url);\n  const data = await response.json();\n  const scores = data.result;\n\n  _DOMselector_js__WEBPACK_IMPORTED_MODULE_0__.listEl.innerHTML = '';\n\n  scores.forEach((item) => {\n    _DOMselector_js__WEBPACK_IMPORTED_MODULE_0__.listEl.innerHTML += `\n      <li>${item.user}: ${item.score}</li>\n    `;\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showList);\n\n//# sourceURL=webpack://Leaderboard/./modules/List.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _Class_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Class.js */ \"./modules/Class.js\");\n/* harmony import */ var _DOMselector_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOMselector.js */ \"./modules/DOMselector.js\");\n/* harmony import */ var _List_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./List.js */ \"./modules/List.js\");\n\n\n\n\nconst submit = (url) => {\n  _DOMselector_js__WEBPACK_IMPORTED_MODULE_1__.formEl.addEventListener('submit', async (e) => {\n    e.preventDefault();\n    const person = new _Class_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](_DOMselector_js__WEBPACK_IMPORTED_MODULE_1__.nameInput.value, _DOMselector_js__WEBPACK_IMPORTED_MODULE_1__.scoreInput.value);\n\n    await fetch(url, {\n      method: 'POST',\n      body: JSON.stringify(person),\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8',\n      },\n    });\n    _DOMselector_js__WEBPACK_IMPORTED_MODULE_1__.nameInput.value = '';\n    _DOMselector_js__WEBPACK_IMPORTED_MODULE_1__.scoreInput.value = '';\n    (0,_List_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(url);\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (submit);\n\n//# sourceURL=webpack://Leaderboard/./modules/Submit.js?");
